...
![责任链模式UML图](../../img/设计模式/ChainOfResponsibilityUML.jpeg)
...
![策略模式UML图](../../img/设计模式/StrategyUML.png)
...
我们先看策略模式，我们其实还是需要去判断选用何种策略模式，那么当判断选用何种策略模式的逻辑相对复杂的时候实际上还是责任链模式比较适合一些，因为责任链模式可以将判断逻辑全部写在自己内部，每个节点之间相互独立，互不影响。
